> 当前范围（2026-09-21）：**RSS 采集全部停用**，每日自动采集只剩人物 · Icons（最多 1 篇）。线上 19 篇 = 成长 4（Dan Koe + Paul Graham 三篇社区译本）+ 人物 6（Anne Hathaway + Icons 5）+ 足球 4（2026-09-17 的存量投入，RSS 已停采）+ AI 5（Offbook Press 官方中英双语长文，**5 期原文各一整篇**，含源站各级小标题，**手动接入、不采集也不翻译**）。旧明星采集停用。人物配置与维护见 [人物栏目说明](PEOPLE-COLUMN.md)。
...
- **内容栏目**：足球 / 成长（英文长文，整篇收录）/ 寓言 / 人物 · Icons（公开原刊全文与摄影）/ AI（Offbook Press 官方中英双语长文 5 篇 = 5 期原文各一整篇，含源站各级小标题）；**每日自动采集现在只更新人物（最多 1 篇）**——足球 RSS 已于 2026-09-17 停采（存量足球文 4 篇仍在线上），成长现有内容不动，AI 栏目是手动接入（`tools/offbook.mjs`，源站自带官方中文，只抽取不翻译），旧明星采集停用
