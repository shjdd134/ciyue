> 当前范围（2026-09-17）：**RSS 采集全部停用**（足球于本日停采），每日自动采集只剩人物 · Icons（最多 1 篇）；成长 6 篇保留但成长 RSS 暂停，AI、旧明星与足球采集停用。人物首批 3 篇为原刊全文与摄影，赞达亚明确排除。配置与维护见 [人物栏目说明](PEOPLE-COLUMN.md)。
...
- **内容栏目**：足球 / 成长（英文长文，整篇收录）/ 寓言 / 人物 · Icons（公开原刊全文与摄影）；**每日自动采集现在只更新人物（最多 1 篇）**——足球 RSS 已于 2026-09-17 停采（存量足球文与封面一并撤下），成长现有内容不动，AI 与旧明星采集停用
