> 当前范围（2026-09-26）：**RSS 采集全部停用**，每日自动采集只剩人物 · Icons（最多 1 篇）。线上 23 篇 = 成长 10（Dan Koe + Paul Graham 三篇社区译本 + James Clear + 书架批次 5 篇）+ 人物 5（Anne Hathaway + Icons 4）+ 足球 5 + 社会 1 + 科技 1 + 历史 1。**AI 栏目（Offbook Press）与人物「梅根·福克斯」已于 2026-09-24 下架**（AI 通道 `tools/offbook.mjs` 的 `ESSAYS` 已摘空）。旧明星采集停用。**2026-09-26 新增书架通道 `tools/shelf.mjs`**：用户点名篇目、全人工精翻（词阅精翻 741 句），并创设 社会 / 科技 / 历史 三个栏目（文章带 `pin:true` 豁免时效闸）。人物配置与维护见 [人物栏目说明](PEOPLE-COLUMN.md)。
...
- **内容栏目**：成长 / 社会 / 科技 / 历史 / 足球 / 人物 · Icons（公开原刊全文与摄影）/ 寓言；**每日自动采集现在只更新人物（最多 1 篇）**——足球 RSS 已于 2026-09-17 停采（存量足球文 4 篇仍在线上），成长现有内容不动，旧明星采集停用。**AI 栏目（Offbook Press 官方中英双语）已于 2026-09-24 整栏下架**，入口与文章一并撤除
