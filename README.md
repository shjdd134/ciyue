> 当前范围（2026-09-18）：**RSS 采集全部停用**，每日自动采集只剩人物 · Icons（最多 1 篇）。线上 14 篇 = 成长 4（Dan Koe + Paul Graham 三篇社区译本）+ 人物 6（Anne Hathaway + Icons 5）+ 足球 4（足球 4 篇是 2026-09-17 的存量投入，RSS 已停采）。成长 RSS 继续暂停，AI 与旧明星采集停用。人物配置与维护见 [人物栏目说明](PEOPLE-COLUMN.md)。
...
- **内容栏目**：足球 / 成长（英文长文，整篇收录）/ 寓言 / 人物 · Icons（公开原刊全文与摄影）；**每日自动采集现在只更新人物（最多 1 篇）**——足球 RSS 已于 2026-09-17 停采（存量足球文 4 篇仍在线上），成长现有内容不动，AI 与旧明星采集停用
...
（`tools/audit.js` 的 `[G8]`：摘掉全部例句后 6 篇的指标与推荐分逐篇不变）。
