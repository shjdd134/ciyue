> 当前范围（2026-09-18）：**RSS 采集全部停用**，每日自动采集只剩人物 · Icons（最多 1 篇）。线上 6 篇 = 成长 1 + 人物 1 + 足球 4（足球 4 篇是 2026-09-17 的存量投入，RSS 已停采）。成长 RSS 继续暂停，AI 与旧明星采集停用。人物配置与维护见 [人物栏目说明](PEOPLE-COLUMN.md)。
