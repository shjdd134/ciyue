...
- **当前版本**：sw v34，词库全库 **4,082 词**（基础层 2,069 + 核心层 2,013），文章 **24 篇**（足球 9 = 2026-09-11 当天 + 寓言 15；AI/明星/历史为 0——2026-09-12 用户要求清理存量，每日管线照常按配额回补 AI/明星/足球，历史源仍断供），另有点词翻译层 38,267 词（阅读页任意单词点击查义）
