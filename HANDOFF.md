...
| 资源版本 | `?v=92` · SW 缓存名 `wordlens-cache-v92`（v92 = 2026-09-26 书架批次：8 篇精翻入库 + 社会/科技/历史三新栏目 + shelf 通道；v91 = 同日中英句对修复：679 条译文校对 + 47 组 `alignedParts`，废弃 cn-dup 显示机制；v90 Word/PDF 词库导入 + 单层查词卡 + 私人书架同日早些时候已部署） |
