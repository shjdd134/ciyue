 ...
 *
 * 缓存策略（v69，句末朗读喇叭退出正文行盒：喇叭从「选中时才 inline 进流」改成绝对定位进
 *   句子块右侧的页面留白，选中不再改变行宽 —— 实测 24 句里 3 句会把末行挤到下一行、
 *   被点句之下整段下移 32px，现在归零。上一条 v68 是点句保持位置）：
 ...
 */
const CACHE = "wordlens-cache-v69";
