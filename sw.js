 ...
 *
 * 缓存策略（v71，AI 栏目封面由渐变改为实图：Offbook 5 篇各配一张主题插画，
 *   `assets/covers/ob-<slug>.jpg`，在 tools/offbook.mjs 的 ESSAYS[].cover 里声明；
 *   qc 的「AI 免封面」豁免随之收窄 —— 前提「Offbook 源站没有位图」已被推翻，
 *   现在 AI 漏图会判 F3，不再静默退回渐变。上一条 v70 是阅读页手势守卫）：
 ...
 */
const CACHE = "wordlens-cache-v71";
